 ...
 * The API target is read from `VITE_API_URL` (defaults to localhost:3000). The `test` block
 * runs the component/interaction suite (jsdom + Testing Library) against the mocked API — no
